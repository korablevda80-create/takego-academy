...
:::signs
🍹 | **Коктейльные наборы** — мини-бутылка алкоголя, напиток, мармелад и стакан со льдом. Готовый коктейль за секунды.
⚡ | **Огромный выбор энергетиков** — 60 видов Монстра и других функциональных напитков со всего мира.
🧊 | **Стакан со льдом** — топовая позиция, должен быть в наличии всегда.
:::
